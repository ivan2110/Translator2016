...
tf.app.flags.DEFINE_integer("src_lang_vocab_size", 40000, "Source language vocabulary size.")
tf.app.flags.DEFINE_integer("dst_lang_vocab_size", 40000, "Destination language vocabulary size.")
...
tf.app.flags.DEFINE_string("dst_lang", "RU", "Destination language.")

FLAGS = tf.app.flags.FLAGS
PATH_TO_DATA_FILES = FLAGS.data_dir + "/" + FLAGS.src_lang + "_" + FLAGS.dst_lang + "/"
...
def create_model(session, forward_only):
  ...
  model = seq2seq_model.Seq2SeqModel(
      FLAGS.src_lang_vocab_size, FLAGS.dst_lang_vocab_size, _buckets,
...
def generate_test_dev_file_names(lang):
  train_suffix = "_indexes_sentences_train.txt"
  dev_suffix = "_indexes_sentences_dev.txt"
  train_file_name = PATH_TO_DATA_FILES + lang + train_suffix
  dev_file_name = PATH_TO_DATA_FILES + lang + dev_suffix
...
def train():
  ...
  #first_lang_train, fr_train, en_dev, fr_dev, _, _ = data_utils.prepare_wmt_data(
  ...
  with tf.Session() as sess:
    ...
    src_lang_train, src_lang_dev = generate_test_dev_file_names(FLAGS.src_lang)
    dst_lang_train, dst_lang_dev = generate_test_dev_file_names(FLAGS.dst_lang)
    dev_set = read_data(src_lang_dev, dst_lang_dev)
    train_set = read_data(src_lang_train, dst_lang_train, FLAGS.max_train_data_size)
...
def generate_src_lang_sentences_file_name(lang):
  train_suffix = "_natural_sentences_dev.txt"
  return PATH_TO_DATA_FILES + lang + train_suffix
